game.things = (function(){
  var items = {
    bat: {
      name: 'bat',
      effects: {
        'player_inventory': { message: "<p>You picked up the usb!</p>",
                            object: "addItem",
                            subject: "deleteItem"
        },
        'dino': { message: "<p>You plugged in you usb to the servers.</p><p>Servers are beeping.</p>",
                  subject: 'deleteItem',
                  object: 'deleteItem',
        ...
        'empty': {
              message: "<p>You set the usb down over there.</p>",
              object: "addItem",
              subject: "deleteItem"
        }
      }
    ...
    dino: {
      name: 'dino',
      effects: {
        'player_inventory': { message: "<p>You can't steal the servers...</p>" } 
      }
    }
  };
